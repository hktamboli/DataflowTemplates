...
public class DataStreamToSpannerIT extends TemplateTestBase {
  ...
  public void testDataStreamMySqlToSpanner() throws IOException {
    ...
    simpleJdbcToSpannerTest(
        ...
        false,
        config -> config.addParameter("inputFileFormat", "avro"));
  }
  ...
  public void testDataStreamMySqlToSpannerJson() throws IOException {
    ...
    simpleJdbcToSpannerTest(
        ...
        Dialect.GOOGLE_STANDARD_SQL,
        false,
        config -> config.addParameter("inputFileFormat", "json"));
  }
  ...
  private void simpleJdbcToSpannerTest(
    ...
    List<String> tableNames =
        List.of(
            "MySqlToSpanner_1_" + RandomStringUtils.randomAlphanumeric(5),
            "MySqlToSpanner_2_" + RandomStringUtils.randomAlphanumeric(5));
    ...
    // Create JDBC tables
    tableNames.forEach(
        tableName -> cloudSqlResourceManager.createTable(tableName, createMySqlSchema()));
    ...
    PipelineLauncher.LaunchConfig.Builder options =
        paramsAdder.apply(
            PipelineLauncher.LaunchConfig.builder(jobName, specPath)
                ...
                .addParameter("sessionFilePath", getGcsPath("input/mysql-session.json"))
